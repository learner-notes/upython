function display_nav() {
  if (document.getElementById('dropdown').style.display == "block") {
    ...
    document.getElementById('dropdown').innerHTML = "<a href='introduction.html'>INTRODUCTION</a><a href='variables.html'>VARIABLES</a><a href='in&out.html'>IN&OUT</a><a href='operators.html'>OPERATORS</a>";
  }
}
